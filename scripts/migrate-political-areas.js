 ...
 * 
 * Usage:
 *   node scripts/migrate-political-areas.js
 * 
 ...
 */
function isOldStructure(politicalAreas) {
 ...
 */
function convertToNewStructure(oldPoliticalAreas) {
  return oldPoliticalAreas.map((item) => {
    ...
    const newItem = {
      ...
      showOnPoliticalAreaPage: true, // Default to false as per your schema change
    };
