...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Huvudmeny",
      description:
        "Dra och släpp för att ändra ordning. Objekt med undermenyer visas inte i sidfoten.",
      type: "array",
      group: "navigation",
      of: [{ type: "menuItem" }],
    }),
    ...
    defineField({
      ...
      description:
        "Länkar till sociala medier. Visas i sidfoten på webbplatsen.",
      type: "socialLinks",
      group: "social",
    }),
    defineField({
